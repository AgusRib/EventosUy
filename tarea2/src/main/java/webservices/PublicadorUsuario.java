...
public interface PublicadorUsuario {
    ...
    @Action(input = "http://webservices/publicadorUsuario/getFileRequest", output = "http://webservices/publicadorUsuario/getFileResponse", fault = {
        @FaultAction(className = IOException_Exception.class, value = "http://webservices/publicadorUsuario/getFile/Fault/IOException")
    })
    public byte[] getFile(
    ...
    public HashSet listarAsistentes();
    ...
    public HashSet listarRegistrosAEventos(
        @WebParam(name = "arg0", partName = "arg0")
        String arg0);
    ...
    public HashSet listarEdicionesOrganizadas(
        @WebParam(name = "arg0", partName = "arg0")
        String arg0);
    ...
    public HashSet listarOrganizadores();
    ...
    public HashSet listarInstituciones();
