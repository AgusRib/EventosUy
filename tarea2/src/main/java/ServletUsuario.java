...
public class ServletUsuario extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null || (action.equals("listarUsuarios"))) {
        		listarUsuarios(request, response);
		} else if ( action.equals("perfil") || (action.equals("detalleUsuario") && usuario.equals(usuarios)) ) {
	...
	private void perfil(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String usuario = request.getParameter("usuario");
					...
					try {
						request.getRequestDispatcher("/WEB-INF/pages/perfil.jsp").
								forward(request, response);
					} catch (ServletException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
