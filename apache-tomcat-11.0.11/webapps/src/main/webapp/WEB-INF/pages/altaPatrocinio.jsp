		...
		<div class="container-xl">
			...
			<section class="card mb-3">
					    ...
					    <div class="mb-3">
					        ...
					        <input type="number" class="form-control" id="aporteEconomico" name="aporte" placeholder="0.00" min="0" step="0.01" required>
					    </div>
					    <div class="mb-3">
					        <label for="registrosGratuitos" class="form-label">Cantidad de registros gratuitos</label>
					        <input type="number" class="form-control" id="registrosGratuitos" name="cantGratis" placeholder="0" min="0" required>
					    ...
					    <div class="mb-3">
					        ...
					        <input type="text" class="form-control" id="codigoPatrocinio" name="codigo" placeholder="Ingrese el código" required>
					    </div>
					    <div class="d-flex gap-2">
					        <button type="submit" class="btn btn-primary">Registrar</button>
					        <a href="/lab2/ServletUsuario" class="btn btn-secondary">Cancelar</a>
					    </div>
					</form>
				</div>
			</section>
